  ...
  <tr>
    ...
    <td align="left"><label for="select"></label>
      <select name="lx" id="lx">
        <option value="1" <?php if($goods['lx']==1){?> selected<?php }?>>激活商品</option>
        <option value="2" <?php if($goods['lx']==2){?> selected<?php }?>>升级商品</option>
        <option value="3" <?php if($goods['lx']==3){?> selected<?php }?>>重消商品</option>
      </select></td>
  </tr>
  <tr>
    <td height="22" align="right">商品名称：</td>
    <td align="left"><input name="goodsname" type="text" id="goodsname" size="20" maxlength="50" value="<?=$goods['goodsname']?>"></td>
  </tr>
  <tr>
