...
<table width="100%" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
      ...
      <tr>
        <td height="10" colspan="10" align="center">委托买入列表</td>
      </tr>
      <tr>
      ...
      <?php
	  	$pagesize = 20; //设置每页记录数 
	  	$sql = "SELECT * FROM `stockbuy` WHERE lx=0 ".$_SESSION['Search']." ".$_SESSION['SearchTime']."";
		...
		$start = $pagesize * ($p - 1); //计算起始记录 
      	$sql = "SELECT * FROM `stockbuy` WHERE lx=0 ".$_SESSION['Search']." ".$_SESSION['SearchTime']." order by sdate desc,id desc limit ".$start.",".$pagesize;
		if($query = mysql_query($sql)){
