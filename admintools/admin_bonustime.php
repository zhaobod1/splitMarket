...
<input type="text" name="TimeEnd" id="TimeEnd" style="width:100px" onFocus="HS_setDate(this)"><input type="submit" name="Search" id="Search" class="btn1" value="搜索"></td>
      ...
      <?php
	  	$pagesize = 20; //设置每页记录数 
	  	$sql = "SELECT * FROM `bonustime` WHERE 1=1 ".$_SESSION['Search']." ".$_SESSION['SearchTime']."";
      ...
      <tr>
        ...
        <td align="center"><input type="button" class="button" id="button" name="button" value="查看" onClick="window.location.href='admin_bonus.php?did=<?=$row['id']?>'" /></td>
      </tr>
      <?php
			}
		}
