...
if (!defined('INIT_NO_USERS'))
{
	...
	if (isset($smarty))
	{
	$smarty->assign('show_oauth_qq', $_CFG['show_oauth_qq']);
	$smarty->assign('show_oauth_weibo', $_CFG['show_oauth_weibo']);
	$smarty->assign('show_oauth_alipay', $_CFG['show_oauth_alipay']);
	$smarty->assign('show_oauth_taobao', $_CFG['show_oauth_taobao']);
	}
