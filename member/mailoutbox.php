...
<table width="100%" cellpadding="3" cellspacing="1" border="0" align="center" class="table1">
      ...
      <tr>
        <td height="5" colspan="5" align="left"><?=$shijiansousuo?>：
      ...
      <div id="daochu">
      <tr>
        <td height="10" colspan="5" align="center"><?=$menu24?></td>
      </tr>
      <tr>
      	<td height="21" align="center"><input type="checkbox" name="checkbox" value="checkbox" onClick="javascript:SelectAll()"></td>
        <td align="center"><?=$faxin1?></td>
        <td align="center"><?=$faxin2?></td>
        <td align="center"><?=$faxin3?></td>
        <td align="center"><?=$faxin4?></td>
        </tr>
      <?php
	  	$pagesize = 20; //设置每页记录数 
      ...
      <tr>
        ...
        <td align="center"><input name="" type="button" class="button_green" value="<?=$anniu5?>" onClick="window.location.href='mailcontent.php?mid=<?=$row['id']?>'"></td>
      </tr>
      <?php
			}
		}
    ...
    <table width="100%" border="0" class="ziti">
          <tr>
            <td align="left"><input name="button4" type="submit" class="button_red" id="button4" value="<?=$faxin5?>" onClick="{if(confirm('您确定要删除该邮件吗?')){this.document.selform.submit();return true;}return false;}"></td>
